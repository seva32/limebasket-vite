function Terms() {
  return (
    <>
      <h1>Privacy Policy for limebasket</h1>

      <p>
        At limebasket, accessible from limebasket.tk, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by limebasket and
        how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in limebasket. This policy is not applicable to
      ...
      <p>
        limebasket follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, limebasket uses &apos;cookies&apos;. These
      ...
      <p>
        ...
        advertising partners of limebasket.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on limebasket, which are sent
      ...
      <p>
        Note that limebasket has no access to or control over these cookies that
      ...
      <p>
        limebasket&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        limebasket does not knowingly collect any Personal Identifiable
      ...
      <p>Welcome to limebasket!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of limebasket&apos;s Website, located at limebasket.tk.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use limebasket if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing limebasket, you agreed to use
        cookies in agreement with the limebasket&apos;s Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, limebasket and/or its licensors own the
        intellectual property rights for all material on limebasket. All
        intellectual property rights are reserved. You may access this from
        limebasket for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from limebasket</li>
        <li>Sell, rent or sub-license material from limebasket</li>
        <li>Reproduce, duplicate or copy material from limebasket</li>
        <li>Redistribute content from limebasket</li>
      </ul>
      ...
      <p>
        ...
        limebasket does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of limebasket,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, limebasket shall not be
      ...
      <p>
        limebasket reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant limebasket a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of limebasket; and (d) the link is
      ...
      <p>
        ...
        e-mail to limebasket. Please include your name, your organization name,
      ...
      <p>
        No use of limebasket&apos;s logo or other artwork will be allowed for
